...
# method name
METHOD_NAME=share_icomut

# docker build parameters (most likely, the defaults are OK)
EXTRA_DOCKER_BUILD_ARGS="--ssh default=$SSH_AUTH_SOCK"
DOCKER_BUILD_PATH="."
...
# build method docker
DOCKER_BUILDKIT=1 docker build -t getzlab/$METHOD_NAME:${VERSION} ${EXTRA_DOCKER_BUILD_ARGS} ${DOCKER_BUILD_PATH}
